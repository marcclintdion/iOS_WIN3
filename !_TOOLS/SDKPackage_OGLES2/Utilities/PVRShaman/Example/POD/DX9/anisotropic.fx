...
static const float4 cMaterial = float4(0.4,0.6,0.9,0.0);
static const float3 cGrainDirection = float3(1.0, 2.0, 0.0);
static const float3 cBaseColour = float3(0.9, 0.2, 0.2);
...
float4 PShader(in VS_OUTPUT In) : COLOR
{
