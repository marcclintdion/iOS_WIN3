glUseProgram(facing_UP_SHADER);   
    ...
    Rotate(lightMatrix, 1, 0, 0, 45);//__________THIS_ALIGNS_THE_FACING_UP_AND_FACING_VIEW_LIGHT_DIRECTION                                                                                                                                     
    //------------------------------------------------------------------------------------------------------          
    ...
    InvertMatrix(undoMatrix, BiasMatrix);     
    //---------------------------------------------------------------------------------------------------------------------------------------------------|__LIGHT             
    LoadIdentity(undoMatrix);      
    InvertMatrix(undoMatrix, modelView);
