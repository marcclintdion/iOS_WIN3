...
//-----------------------------------------------------------------------------------------------------------------      
      ...
      "            varTexcoord           =  texture * 19.2698 + 19.2698;                                                                        \n"                           
...
//--------------------------------------------------------------------------------------------------------------    
      ...
      " 		               shadowTransform            =  shadowTexcoord;                                                   \n"       
      " 		               shadowTransform.xy        +=  distanceFromLight * 0.2;                                                   \n"      
      
      " 		               distanceFromLight          =  shadow2DProj(ShadowTexture, shadowTransform).r;                       \n"                            
...
//_________________________________linearAttenuation  =  0.43
//============================================================  
"   t=texture2D(HeightMap,dp.xy);                                                                                               \n"
"   dp += ds * w * (t.r - dp.z) / (iz/(t.g*t.g) + 1.0);                                                                         \n"
//--------------------------------
//_________________________________constantAttenuation  =  1.46
//_________________________________linearAttenuation  =  0.2
//============================================================   
"   t=texture2D(HeightMap,dp.xy);                                                                                               \n"
"   dp += ds * w * (t.r - dp.z) / (iz/(t.g*t.g) + 1.0);                                                                         \n"
//--------------------------------
...
"   dp += ds * w * (t.r - dp.z) / (iz/(t.g*t.g) + 1.0);                                                                         \n"
//--------------------------------
//_________________________________facing_UP_constantAttenuation             =  0.665;
//_________________________________facing_UP_linearAttenuation               =  0.245502;
//============================================================  
...
;
      ...
      UNIFORM_undoMatrix_facing_UP                      = glGetUniformLocation(facing_UP_SHADER,   "undoMatrix");      
