glUseProgram(facing_UP_SHADER);                                                                                                                                              
    ...
    //AssignMatrix(tempMatrix, modelView);    
    //mtx3x3LoadIdentity(undoMatrix);      
    //mtx3x3FromTopLeftOf4x4(undoMatrix, tempMatrix);
    //mtx3x3Transpose(undoMatrix,  undoMatrix);
    //mtxTranspose(undoMatrix,undoMatrix);
    //----------------------------------------------------------------------------------------------------------    
    Rotate(modelView, 1, 0, 0,  30.2501-rotateModelWithLeftMouse[0]*.4);//--MODEL
    ...
    glUniformMatrix4fv(UNIFORM_undoMatrix_facing_UP,      1,0,  undoMatrix);                                                                                                           
    //---------------------------------------------------------------------------------
