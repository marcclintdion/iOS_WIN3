...
//#################################################################################################################################        
     ...
     "    varying highp vec4  lightPosition_PASS;                                                                                \n"                       
      ...
      //-----------------------------------------------------------------------------------------------------------------------------
      "         gl_FragColor           = clamp(vec4(1.0, 1.0, 1.0, 1.0) * NdotL2, 0.0, 1.0);                                    \n"
...
;
      ...
      //-------------------------------------
      UNIFORM_zDirBias_lightSpheres                        = glGetUniformLocation(lightSpheres_SHADER,   "zDirBias");      
      //-------------------------------------
      UNIFORM_TEXTURE_SHADOW_lightSpheres                  = glGetUniformLocation(lightSpheres_SHADER,   "ShadowTexture");        
      UNIFORM_TEXTURE_HEIGHT_lightSpheres                  = glGetUniformLocation(lightSpheres_SHADER,   "HeightMap");                                                      
