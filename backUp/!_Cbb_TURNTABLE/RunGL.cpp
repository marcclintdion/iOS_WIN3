...
//------------------------------------
GLuint fbo, color, depth, mainLightPass_fboId, mainLightPass_depth;
...
GLfloat     frameBufferPlane_GaussianHorizontal_blurRadius                              =    2.6; 
...
GLfloat     frameBufferPlane_GaussianVertical_blurRadius                                =    2.6;  
...
//---------------------------------------------------------------------------------------
var           eyeposition[]      =  {-0.0, 2.35, 36.45, 0.0};
var           lookAt[]           =  {0, -2.8, 0, 0.0};
var           rotateModelWithLeftMouse[]           =  {7.90001, -5.46575e-006, };
//------------------------
var           turnTable                                        =   -0.0;
//------------------------------------------------------------------------------
...
var           eyeposition_SHADOW[]                             =  {0.3, 0.3, 0.2, 0.0};
...
//######################################################################################################################
                               ...
                               //====================================================================================                                          
                               var         lightSpheres_LIGHT_POSITION_01[]        =  {0, 0.01, 10.701, 0.0};
...
//==========================================================================================================================================================================
    ...
    glGenTextures(1, &textureMap[3]);
    glBindTexture(GL_TEXTURE_2D, textureMap[3]);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, (GLsizei)viewWidth / resize_SHADOW_FBO, (GLsizei)viewHeight / resize_SHADOW_FBO, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);  
    glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, geometryLightPass_fboId);
    glFramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, GL_COLOR_ATTACHMENT0_EXT, GL_TEXTURE_2D, textureMap[3], 0);
    glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, 0);
    //==================================================================================================================== 
    ...
    glFramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, GL_COLOR_ATTACHMENT0_EXT, GL_TEXTURE_2D, textureMap[4], 0);
    glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, 0);
...
void ProcessKeyboard(void)
{
   ...
   //=======================================================================================  
    ...
    {	                                                                                                                                  
             frameBufferPlane_GaussianHorizontal_blurRadius                   +=  0.05;                                                                            
             frameBufferPlane_GaussianVertical_blurRadius                       +=  0.05;  
    }	                                                                                                                                  
