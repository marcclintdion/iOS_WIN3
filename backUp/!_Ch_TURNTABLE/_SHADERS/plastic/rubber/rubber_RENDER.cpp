   ...
   MultiplyMatrix(mvpMatrix, projection, modelView);                                                                                                                         
    ...
    //---------------------------------------------------------------------------------       
    glUniform1f(UNIFORM_CONSTANT_ATTENUATION_rubber,  facing_VIEW_constantAttenuation);     
    glUniform1f(UNIFORM_LINEAR_ATTENUATION_rubber,    facing_VIEW_linearAttenuation); 
    glUniform1f(UNIFORM_QUADRATIC_ATTENUATION_rubber, facing_VIEW_quadraticAttenuation);    
    //---------------------------------------------------------------------------------    
