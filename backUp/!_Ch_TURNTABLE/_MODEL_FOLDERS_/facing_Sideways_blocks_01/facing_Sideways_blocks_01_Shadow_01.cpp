...
//-------------------------------------------------------------
      ...
      gluLookAt(LightModelViewMatrix, eyeposition[0] + eyeposition_SHADOW[0] - eyeposition[0] * adjustLookAtMove[0], 
       ...
       //----------------------------------------------------------------------------------------
       Translate(LightModelViewMatrix, facing_VIEW_blocks_01_POSITION[0] * scaleMoveShadows[0], facing_VIEW_blocks_01_POSITION[1] * scaleMoveShadows[1], facing_VIEW_blocks_01_POSITION[2] * scaleMoveShadows[2]);                                                                                         
       Rotate(LightModelViewMatrix, facing_VIEW_blocks_01_ROTATE[0], facing_VIEW_blocks_01_ROTATE[1], facing_VIEW_blocks_01_ROTATE[2], facing_VIEW_blocks_01_ROTATE[3]);          
