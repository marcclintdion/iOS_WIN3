   ...
   glBindBuffer(GL_ARRAY_BUFFER, facing_UP_blocks_01_VBO);                                                                                                                                
    ...
    //---------------     
    glUniformMatrix4fv(UNIFORM_viewMatrix_facing_VIEW,      1,0,  viewMatrix);     
    //---------------  
    ...
    glUniform4f(UNIFORM_offset_facing_UP,                        offsetFinalShadow[0], 
                                                                 ...
                                                                 offsetFinalShadow[3]);      
    //---------------------------------------------------------------------------------    
    glUniform4f(UNIFORM_LIGHT_POSITION_01_facing_UP, facing_UP_blocks_01_LIGHT_POSITION_01[0], 
                                                     facing_UP_blocks_01_LIGHT_POSITION_01[1], 
                                                     facing_UP_blocks_01_LIGHT_POSITION_01[2], 
                                                     facing_UP_blocks_01_LIGHT_POSITION_01[3]);      
    //---------------------------------------------------------------------------------     
