...
;
      ...
      //-------------------------------      
      UNIFORM_viewMatrix_facing_UP                      = glGetUniformLocation(facing_UP_SHADER,   "viewMatrix");              
      //-------------------------------
      UNIFORM_SHADOW_PROJ_facing_UP                     = glGetUniformLocation(facing_UP_SHADER,   "projectionShadow");                                                  
      UNIFORM_modelViewShadow_facing_UP                 = glGetUniformLocation(facing_UP_SHADER,   "modelViewShadow");            
      //-------------------------------
