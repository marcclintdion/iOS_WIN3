...
;
      ...
      //-------------------------------      
      UNIFORM_viewMatrix_facing_VIEW                      = glGetUniformLocation(facing_VIEW_SHADER,   "viewMatrix");              
      //-------------------------------
      UNIFORM_SHADOW_PROJ_facing_VIEW                     = glGetUniformLocation(facing_VIEW_SHADER,   "projectionShadow");                                                    
      UNIFORM_modelViewShadow_facing_VIEW                 = glGetUniformLocation(facing_VIEW_SHADER,   "modelViewShadow");                                                    
      //-------------------------------      
