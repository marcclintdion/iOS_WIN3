glUseProgram(SHADER_shadow_44bit_Stride);
      LoadIdentity(modelView);                                                                                                                                                  
       ...
       //----------------------------------------------------------------------------------------
       //------------------------------------------------------------
       Translate(modelView, facing_UP_blocks_01_POSITION[0] * scaleMoveShadows[0], facing_UP_blocks_01_POSITION[1] * scaleMoveShadows[1], facing_UP_blocks_01_POSITION[2] * scaleMoveShadows[2]);                                                                                         
