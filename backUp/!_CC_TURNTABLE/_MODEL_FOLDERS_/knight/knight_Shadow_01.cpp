glUseProgram(SHADER_shadow_32bit_Stride);
      LoadIdentity(modelView);                                                                                                                                                  
       ...
       //----------------------------------------------------------------------------------------
       //-----------------------------------------------------------------------------------------             
       Translate(modelView, knight_POSITION[0] * scaleMoveShadows[0]+ knightShadowPosition[0], knight_POSITION[1] * scaleMoveShadows[1]+ knightShadowPosition[1], knight_POSITION[2] * scaleMoveShadows[2]+ knightShadowPosition[2]);        
