...
//====================================================================================                                          
   ...
   //=======================================================================================  
    ...
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[0]         +=  0.11;                                                                            
    }                                                                                                                                   
    ...
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[1]         +=  0.11;                                                                            
    }	                                                                                                                                  
    ...
    {	                                                                                                                                  
             goldenSunset_LIGHT_POSITION_01[2]         +=  0.11;                                                                          
    }	                                                                                                                                  
   ...
   //==============================================================================
    ...
    if(keys[VK_F8])
    {
         ...
         //---------------------------------------------------------------------------------------------------------------------------------  
             ...
             //------------------------------------------------------------------------------------------------------------------------------       
             outSettings << "var           knightShadowPosition[]           =  {"   << knightShadowPosition[0] << ", "
                                                                             << knightShadowPosition[1] << ", "
                                                                             << knightShadowPosition[2] << ", 1.0};\n\n";                
