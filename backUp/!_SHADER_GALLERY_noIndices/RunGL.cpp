...
//##################################################################################################################################################################################################          
        ...
        PerspectiveMatrix(projection, 45,viewWidth / viewHeight, 0.1, 10000);
        //=========================================================================================================================================================
        #ifdef __APPLE__
...
void ProcessKeyboard(void)
{
    ...
    if (keys['L'])                                                                                                                      
    {	                                                                                                                                  
             renderMonkeyish_J_LIGHT_POSITION_01[0]         +=  0.1;                                                                            
    }                                                                                                                                   
    if (keys['J'])                                                                                                                   
    {                                                                                                                                   
             renderMonkeyish_J_LIGHT_POSITION_01[0]         -=  0.1;                                                                         
    ...
    if (keys['I'])                                                                                                                      
    {	                                                                                                                                  
             renderMonkeyish_J_LIGHT_POSITION_01[1]         +=  0.1;                                                                            
    }	                                                                                                                                  
    if (keys['K'])                                                                                                                      
    {	                                                                                                                                  
             renderMonkeyish_J_LIGHT_POSITION_01[1]         -=  0.1;                                                                            
    ...
    if (keys['O'])                                                                                                                      
    {	                                                                                                                                  
             renderMonkeyish_J_LIGHT_POSITION_01[2]         +=  0.1;                                                                            
    }	                                                                                                                                  
    if (keys['U'])                                                                                                                      
    {	                                                                                                                                  
             renderMonkeyish_J_LIGHT_POSITION_01[2]         -=  0.1;      
    ...
    if (keys['C'])                                                                                                                      
    {	                                                                                                                                  
            renderMonkeyish_J_NOISE_SCALE                    +=  0.0005;                                                                            
    }	                                                                                                                                  
    if (keys['V'])                                                                                                                      
    {	                                                                                                                                  
            renderMonkeyish_J_NOISE_SCALE                    -=  0.0005;                                                                            
       ...
       if(keys[VK_F8])
       {
             ...
             outSettings << "var         renderMonkeyish_J_LIGHT_POSITION_01[]    =  {"   << renderMonkeyish_J_LIGHT_POSITION_01[0] << ", "
                                                                                          << renderMonkeyish_J_LIGHT_POSITION_01[1] << ", "
                                                                                          << renderMonkeyish_J_LIGHT_POSITION_01[2] << ", 1.0};\n\n";            
