      ...
      "         gl_FragColor          = texture2D(Texture1, varTexcoord.st)  * color + (1-NdotL1) *.24;                                                                   \n"                
      ...
      glBindAttribLocation(shinyPlasticInverse_SHADER, 1, "texture");                                                                                             
      //glBindAttribLocation(shinyPlasticInverse _SHADER, 2, "normal");                                                                                           
      //------------------------------------------------                                                                                              
