      ...
      "         color                +=  vec4(1.0, 1.0, 1.0, 1.0) * pow(NdotL1, 45.2) *.8;                                  \n"
    
      "         color                +=  vec4(1.0, 1.0, 1.0, 1.0) * pow(NdotL1, shininess)*.8;                              \n"    
      
      "         gl_FragColor          =  texture2D(Texture1, varTexcoord.st)  *color * attenuation +(1 - NdotL1) *0.1;   \n"                    
      ...
      glBindAttribLocation(frostyPlastic_SHADER, 1, "texture");                                                                                             
      //glBindAttribLocation(frostyPlastic _SHADER, 2, "normal");                                                                                           
      //------------------------------------------------                                                                                              
