      ...
      glBindAttribLocation(dullPlastic_SHADER, 1, "texture");                                                                                             
      //glBindAttribLocation(dullPlastic _SHADER, 2, "normal");                                                                                           
      //------------------------------------------------                                                                                              
      ...
      UNIFORM_LIGHT_MATRIX_dullPlastic                    = glGetUniformLocation(dullPlastic_SHADER,   "lightMatrix");                                            
