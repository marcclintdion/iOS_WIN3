      ...
      "     lightPosition_PASS      = lightMatrix * normalize(light_POSITION_01 - ecPos);                              \n"                           
      "     varTexcoord             = texture;                                                                 \n"                           
      ...
      glBindAttribLocation(velvet_SHADER, 1, "texture");                                                                                             
      //glBindAttribLocation(velvet _SHADER, 2, "normal");                                                                                           
      //------------------------------------------------                                                                                              
