     ...
     "    }\n";                                                                                                                             
      ...
      "         gl_FragColor          = ((texture2D(Texture1, varTexcoord.st) * (color * NdotL1)) + (1-NdotL1)*.10);     \n" 
      ...
      glBindAttribLocation(liquidShiny_01_SHADER, 1, "texture");                                                                                             
      //glBindAttribLocation(liquidShiny_01 _SHADER, 2, "normal");                                                                                           
      //------------------------------------------------                                                                                              
