...
//----------------------------------------------------------------------------------------   
    LoadIdentity(modelViewShadow);                                                                                                                                                  
       ...
       //----------------------------------------------------------------------------------------
       Translate(modelViewShadow, flowerShield_POSITION[0] * scaleMoveShadows[0], 
                                  flowerShield_POSITION[1] * scaleMoveShadows[1], 
                                  flowerShield_POSITION[2] * scaleMoveShadows[2]);                                                                                         
       
       Rotate(modelViewShadow,    flowerShield_ROTATE[0], 
                                  flowerShield_ROTATE[1], 
                                  flowerShield_ROTATE[2], 
                                  flowerShield_ROTATE[3]);         
       
       Scale(modelViewShadow, scaleShadowSize, scaleShadowSize, scaleShadowSize);       
       //---------------------------------------------------------------------------------------------------------------------------------------------------|__MODEL             
