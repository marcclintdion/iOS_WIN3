...
#include    "_SHADERS/SHADOWS/processShadow_32bit_Stride_GLOBALS.cpp" 
#include    "_SHADERS/SHADOWS/processShadow_44bit_Stride_GLOBALS.cpp" 
#include    "GLOBALS.cpp"
...
*/
     ...
     if(shaderNumber == 44)
     {    
            #include "_SHADERS/ConeStep_01/steepPointy.cpp"                                  
     }
     //-------------------------------------------------------------------------------------- 
     if(shaderNumber == 45)
     {    
            #include "_SHADERS/ConeStep_01/shallowRound.cpp"                                
     }
     //-------------------------------------------------------------------------------------- 
     if(shaderNumber == 46)
     {    
            #include "_SHADERS/wood/goldenSunset_RENDER.cpp"
     }
     //-------------------------------------------------------------------------------------- 
     if(shaderNumber == 47)
     {    
            #include "_SHADERS/SHADOWS/processShadow_32bit_Stride_RENDER.cpp"
     }
     //-------------------------------------------------------------------------------------- 
...
//====================================================================================================================================================    
       ...
       glBindTexture(GL_TEXTURE_2D, shadowMap_2D);      
       #include "processShadow_RENDER.cpp" 
...
//====================================================================================                                          
   ...
   //=======================================================================================  
    ...
    {	                                                                                                                                  
             facing_Sideways_blocks_01_LIGHT_POSITION_01[0]         +=  0.11;                                                                            
    }                                                                                                                                   
    ...
    {	                                                                                                                                  
             facing_Sideways_blocks_01_LIGHT_POSITION_01[1]         +=  0.11;                                                                            
    }	                                                                                                                                  
    ...
    {	                                                                                                                                  
             facing_Sideways_blocks_01_LIGHT_POSITION_01[2]         +=  0.11;                                                                          
    }	                                                                                                                                  
    ...
    if (keys['M'] && !keys[VK_SHIFT] && !keys[VK_CONTROL])                                                                                                                      
    {	                                                                                                                                  
             facing_VIEW_constantAttenuation                    +=  0.001;                                                                            
    }	                                                                                                                                  
    if (keys['N'] && !keys[VK_SHIFT] && !keys[VK_CONTROL])                                                                                                                      
    {	                                                                                                                                  
             facing_VIEW_constantAttenuation                    -=  0.001;                                                                            
...
*/    //-----------------------------------------------------------------------------    
   //==============================================================================
    ...
    if(keys[VK_F8])
    {
         ...
         outSettings << "                               var         facing_VIEW_constantAttenuation         =  "    << facing_VIEW_constantAttenuation << ";\n";
         ...
         outSettings << "                               var         turnTable            =   "    << turnTable << ";\n\n\n";           
         ...
         //---------------------------------------------------------------------------------------------------------------------------------  
             ...
             //------------------------------------------------------------------------------------------------------------------------------       
             outSettings << "var           facing_Sideways_blocks_01_LIGHT_POSITION_01[]           =  {"   << facing_Sideways_blocks_01_LIGHT_POSITION_01[0]    << ", "
