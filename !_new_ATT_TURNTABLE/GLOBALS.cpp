...
//---------------------------------------------------------------------------------------
var           eyeposition[]                                    =  {  0, 4.75, 37.5, 0.0};
var           lookAt[]                                         =  {  0, -2.8, 0, 0.0};
var           rotateModelWithLeftMouse[]                       =  {  0.0, 0.0};
//---------------------------------------------------------------------------------------
var           turnTable                                        =     0.0;
...
var           eyeposition_SHADOW[]                             =  {4.75, 0.85, 5.7, 1.0};
var           lookAt_SHADOW[]                                  =  {  0.0, -2.8, 0.0};
...
//============================================================================================================================================
                               ...
                               //====================================================================================
                               var         steepPointy_constantAttenuation                           =    0.860001;
                               var         steepPointy_linearAttenuation                             =   -3.0645;
                               var         steepPointy_quadraticAttenuation                          =    4.80521;
