...
//-----------------------------------------------------------------------------------------------------------------      
      ...
      "            vec3 eyeSpaceTangent  =  (mvMatrix * vec4(1.0, varTexcoord, 0.0));                                                \n"  
                   //-------------------
...
//#################################################################################################################################        
      ...
      "    void setVIEW_ray_ps(in vec2 texCoordinates, out vec3 rayPos, out vec3 rayVec);                                         \n"       
      //=============================================================================================================================     
...
"{                                                                                                                                \n" 
      ...
      "                                      + 0.385    * distanceToLight                                             \n"
      "                                      + .063 * distanceToLight * distanceToLight);                         \n" 
...
;
      ...
      glGenBuffers(1, &facing_VIEW_INDEX_VBO);                       
      glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, facing_VIEW_INDEX_VBO);                   
