...
//###############################################################################################################################################       //------------------------------------------------------------------------------------                                          
       ...
       //----------------------------------------------------------------------------------------
       //-----------------------------------------------------------------------------------------             
       Translate(modelView, knight_POSITION[0] * scaleMoveShadows[0], knight_POSITION[1] * scaleMoveShadows[1]+.5, knight_POSITION[2] * scaleMoveShadows[2]+.1);        
       Rotate(modelView, knight_ROTATE[0], knight_ROTATE[1], knight_ROTATE[2], knight_ROTATE[3]);        
       Scale(modelView, scaleShadowSize[0], scaleShadowSize[1]*1.5, scaleShadowSize[2]);    
          //--------------------------------------------------------------------------
...
//=========================================================================================================================================
       ...
       //----------------------------------------------------------------------------------------
       //-----------------------------------------------------------------------------------------             
       Translate(modelView, knight_POSITION[0] * scaleMoveShadows[0] -.85, knight_POSITION[1] * scaleMoveShadows[1]+.3, knight_POSITION[2] * scaleMoveShadows[2]-.5);        
       Rotate(modelView, 0.0, -1.0, 1.0, knight_ROTATE[3]+20);        
       Scale(modelView, scaleShadowSize[0], scaleShadowSize[1]*2.0, scaleShadowSize[2]);    
