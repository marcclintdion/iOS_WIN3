...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%           
			      ...
			      { 
                          marcWalking = true;                     
                          eyePosition[1]                     -= .01820   * frameRateAdjustment;
                          eyePosition[2]                     += .00752   * frameRateAdjustment;
                          
                          marcModelPosition[1]               += .00000    * frameRateAdjustment;                          
...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
			      ...
			      {              
                                 ...
                                 eyePosition[1]                += .01293  *   frameRateAdjustment;                                
                                 eyePosition[2]                -= .00536  *   frameRateAdjustment;
