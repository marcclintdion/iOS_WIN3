...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%           
			      ...
			      { 
                          marcWalking = true;                     
                          eyePosition[1]                     -= .013895   * frameRateAdjustment;
                          eyePosition[2]                     += .013895   * frameRateAdjustment;
...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
			      ...
			      {              
                                 ...
                                 eyePosition[1]                += .0099  *   frameRateAdjustment;                                
                                 eyePosition[2]                -= .0099  *   frameRateAdjustment;
