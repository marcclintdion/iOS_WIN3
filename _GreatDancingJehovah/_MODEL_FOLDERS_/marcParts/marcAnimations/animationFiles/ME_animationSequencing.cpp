     ...
     if(mainBodyPosition_animationBlendFactor >= 0.0f && mainBodyPosition_animationBlendFactor <= 1.0f)
     {
         ...
         mainBodyPosition[2]           = mainBodyPosition_MOVE_FRAMEA[2]     * (1 - mainBodyPosition_animationBlendFactor) 
               ...
               if(mainBodyPosition_setSelection == 0)
               {
                    mainBodyPosition[1]     +=lowerToJumpVelocityMarc;
                    lowerToJumpVelocityMarc -= 0.01;
               }     
               if(mainBodyPosition_setSelection == 2)
               {
                    mainBodyPosition[1]     += distanceMarcJump;
                    distanceMarcJump        += initialVelocityOfMarcJump * timeOfMarcJump - 4.9 * timeOfMarcJump * timeOfMarcJump;   
               }      
     }
     ...
     mainBodyPosition_animationBlendFactor += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment;
       ...
       {    
        ...
        animationBlendFactor_LEFT_ARM  += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment; 
                            ...
                            animationBlendFactor_HEAD       += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment;   
        ...
        animationBlendFactor_TORSO       += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment;    
                             ...
                             animationBlendFactor_HIPS       += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment;   
                            ...
                            if(animationBlendFactor_RIGHT_ARM >= 0.0f && animationBlendFactor_RIGHT_ARM <= 1.0f)
                             ...
                             animationBlendFactor_RIGHT_ARM       += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment;  
        ...
        animationBlendFactor_LEFT_LEG       += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment; 
                             ...
                             animationBlendFactor_RIGHT_LEG       += LEFT_ARM_FRAME_TIME_01*frameRateAdjustment;    
