...
//#include "../_MODEL_FOLDERS_/tile_2m/tile_2m_Render.cpp" 
//--------------------------------------------------------------
        pyramidTile_POSITION[0] =   0.0;
        pyramidTile_POSITION[1] =   0.0;
        pyramidTile_POSITION[2] =  -2.0;
        //--------------------------
        pyramidTile_ROTATE[0]   =   0.0; 
        pyramidTile_ROTATE[1]   =   0.0; 
        pyramidTile_ROTATE[2]   =   1.0; 
        pyramidTile_ROTATE[3]   =   0.0; 
