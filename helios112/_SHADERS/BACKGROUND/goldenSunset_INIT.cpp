    ...
    "            //----------------------------------------------------------------------------                           \n"        
    "            shadowLayer  =  texture2D(ShadowTexture, shadowTexcoord.st).r                                            \n" 
        "                           *  texture2D(ShadowTexture, shadowTexcoord.st).g;                                     \n" 
    "            shadow          =  vec4(shadowLayer, shadowLayer, shadowLayer,  shadowLayer);                            \n" 
   "            //----------------------------------------------------------------------------                            \n" 
