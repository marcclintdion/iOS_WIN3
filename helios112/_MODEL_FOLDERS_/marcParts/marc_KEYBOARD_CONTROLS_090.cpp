...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%           
			      ...
			      { 
                          marcWalking = true;                     
                          eyePosition[1]                     -= .01965    * frameRateAdjustment;
                          eyePosition[2]                     += .00000    * frameRateAdjustment;
...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
			      ...
			      {              
                                 marcWalking = true;                    
                                 eyePosition[1]              += .01965    * frameRateAdjustment;                                 
                                 eyePosition[2]              -= .000      * frameRateAdjustment;
...
//____%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
			      ...
			      {              
                                 ...
                                 eyePosition[1]                += .014   *   frameRateAdjustment;                                
                                 eyePosition[2]                -= .000   *   frameRateAdjustment;
