    ...
    UNIFORM_shininess_spikes_00 = glGetUniformLocationARB(  spikes_00_SHADER, "shiny" );   

    UNIFORM_counter1_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, "counter1" );

    UNIFORM_counter2_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, "counter2" );

    UNIFORM_counter3_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, "counter3" );

    UNIFORM_counter4_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, "counter4" );
