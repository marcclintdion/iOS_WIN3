...
void init(void)
{
    ...
    glEnable(GL_DEPTH_TEST);                            // Enable the depth test (also called z buffer)
     ...
     ObjLoad ("spikes_00.3ds","skull.bmp");
...
system("MKDIR spikes_00");

ofstream out_vboGlobals("spikes_00/spikes_00_vboGlobals.cpp");
         out_vboGlobals << "GLuint spikes_00_vboID   =  " << vboID <<" ;"                                << "\n\n";
         out_vboGlobals << "GLuint spikes_00_SHADER;"                                                    << "\n";
         out_vboGlobals << "GLuint spikes_00_SHADER_Vertex;"                                             << "\n";
         out_vboGlobals << "GLuint spikes_00_SHADER_Fragment;"                                           << "\n\n";

         out_vboGlobals << "#include \"spikes_00_VERT.cpp\""                                             << "\n";         
         out_vboGlobals << "#include \"spikes_00_NORM.cpp\""                                             << "\n";
         out_vboGlobals << "#include \"spikes_00_TEX.cpp\""                                              << "\n";
        
         out_vboGlobals << "GLfloat     spikes_00_POSITION[]           =  {0.0, 0.0, 0.0};"              << "\n\n";          
         
         out_vboGlobals << "GLfloat     lightPos_spikes_00[]           =  {-1.56117, 11.9431, 10.7077};" << "\n";        
         out_vboGlobals << "GLfloat     lightAttenuation_spikes_00     =   1.283;"                       << "\n\n";  
                             
         out_vboGlobals << "//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"       << "\n";  
         out_vboGlobals << "GLfloat    shininess_spikes_00               = 199.733f;"                      << "\n";  
         out_vboGlobals << "GLuint     UNIFORM_shininess_spikes_00;"                                       << "\n";   
         out_vboGlobals << "//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"       << "\n";           
         
         out_vboGlobals << "GLfloat     rotation_AXIS_spikes_00[]      =  {1.0, 1.0, 1.0, 0.0};"         << "\n";          
        
         
         out_vboGlobals << "GLfloat     spikes_00_counter1             =   0.0;"                         << "\n";           
         out_vboGlobals << "GLfloat     spikes_00_counter2             =   0.0;"                         << "\n";
         out_vboGlobals << "GLfloat     spikes_00_counter3             =   0.0;"                         << "\n";         
         out_vboGlobals << "GLfloat     spikes_00_counter4             =   0.0;"                         << "\n";         
                  
         out_vboGlobals << "GLuint      UNIFORM_counter1_spikes_00;"                                     << "\n\n"; 
         out_vboGlobals << "GLuint      UNIFORM_counter2_spikes_00;"                                     << "\n\n"; 
         out_vboGlobals << "GLuint      UNIFORM_counter3_spikes_00;"                                     << "\n\n";          
         out_vboGlobals << "GLuint      UNIFORM_counter4_spikes_00;"                                     << "\n\n";          
         
         out_vboGlobals << "GLfloat     LightAmbient_spikes_00[]        = { 1.0f, 1.0f, 1.0f, 1.0f};"    << "\n";
         out_vboGlobals << "GLfloat     LightDiffuse_spikes_00[]        = { 1.0f, 1.0f, 1.0f, 1.0f};"    << "\n";
         out_vboGlobals << "GLfloat     LightSpecular_spikes_00[]       = { 1.0f, 1.0f, 1.0f, 1.0f};"    << "\n";
         out_vboGlobals << "GLfloat     MaterialAmbient_spikes_00[]     = { 1.0f, 1.0f, 1.0f, 1.0f};"    << "\n";
         out_vboGlobals << "GLfloat     MaterialDiffuse_spikes_00[]     = { 1.0f, 1.0f, 1.0f, 1.0f};"    << "\n";
         out_vboGlobals << "GLfloat     MaterialEmission_spikes_00[]    = { 1.0f, 1.0f, 1.0f, 1.0f};"    << "\n";
         out_vboGlobals << "GLfloat     MaterialSpecular_spikes_00[]    = { 0.0, 0, 0};"                 << "\n";
         
                                        
         out_vboGlobals << "GLfloat     scalespikes_00ShadowY[]         = {1.26801, 0.0, 1.26801};"  << "\n";
//////////////////////////////////////////////////////_______GLOBALS_______///////////////////////////////////////////////////////////
//////////////////////////////////////////////////////_______GLOBALS_______///////////////////////////////////////////////////////////
                                         //---------------------------------------------                                                 
//////////////////////////////////////////////////////________INIT_______///////////////////////////////////////////////////////////
//////////////////////////////////////////////////////________INIT_______///////////////////////////////////////////////////////////
ofstream out_vboInit("spikes_00/spikes_00_vboInit.cpp");
         
         out_vboInit << "glGenBuffersARB(1, &spikes_00_vboID);" << "\n";
         out_vboInit << "glBindBufferARB(GL_ARRAY_BUFFER_ARB, spikes_00_vboID);" << "\n";
         out_vboInit << "glBufferDataARB(GL_ARRAY_BUFFER_ARB,       sizeof(spikes_00_VERT) + sizeof(spikes_00_NORM) + sizeof(spikes_00_TEX), 0, GL_STATIC_DRAW_ARB);" << "\n";
         out_vboInit << "glBufferSubDataARB(GL_ARRAY_BUFFER_ARB, 0, sizeof(spikes_00_VERT), spikes_00_VERT);" << "\n"; 
         out_vboInit << "glBufferSubDataARB(GL_ARRAY_BUFFER_ARB,    sizeof(spikes_00_VERT),  sizeof(spikes_00_NORM), spikes_00_NORM);" << "\n";
         out_vboInit << "glBufferSubDataARB(GL_ARRAY_BUFFER_ARB,    sizeof(spikes_00_VERT) + sizeof(spikes_00_NORM), sizeof(spikes_00_TEX), spikes_00_TEX);" << "\n\n\n";
         
         out_vboInit << "    loadTexture(\"_MODEL_FOLDERS_/spikes_00/spikes_00_DOT3.bmp\",   normalMap["   << textureMapID << "]);"   << "\n";
         out_vboInit << "    loadTexture(\"_MODEL_FOLDERS_/spikes_00/spikes_00.jpg\",        textureMap["  << textureMapID << "]);"   << "\n";
         out_vboInit << "    //loadTexture(\"_MODEL_FOLDERS_/spikes_00/spikes_00_BUMP.jpg\", specularMap[" << textureMapID << "]);"   << "\n";
//////////////////////////////////////////////////////________INIT_______///////////////////////////////////////////////////////////
//////////////////////////////////////////////////////________INIT_______///////////////////////////////////////////////////////////                                        
                                         //---------------------------------------------
                                        //--------------------------------------------- 
...
/////////////////////////////////////////////////////_____SHADER_SETUP_____////////////////////////////////////////////////////////// 
ofstream out_SHADER_INIT("spikes_00/spikes_00_shaderInit.cpp");         

         out_SHADER_INIT << "    const char *spikes_00_SHADER_VertexStrings[1];" << "\n";
         out_SHADER_INIT << "    const char *spikes_00_SHADER_FragmentStrings[1];" << "\n\n";
   
         out_SHADER_INIT << "    spikes_00_SHADER_Vertex = glCreateShaderObjectARB( GL_VERTEX_SHADER_ARB );" << "\n\n";    

         out_SHADER_INIT << "	 unsigned char *spikes_00_SHADER_VertexAssembly = readShaderFile( \"_MODEL_FOLDERS_/spikes_00/spikes_00.vert\" );" << "\n";
         out_SHADER_INIT << "    spikes_00_SHADER_VertexStrings[0] = (char*)spikes_00_SHADER_VertexAssembly;" << "\n";
         out_SHADER_INIT << "    glShaderSourceARB( spikes_00_SHADER_Vertex, 1, spikes_00_SHADER_VertexStrings, NULL );" << "\n";
         out_SHADER_INIT << "    glCompileShaderARB( spikes_00_SHADER_Vertex);" << "\n";
         out_SHADER_INIT << "    delete spikes_00_SHADER_VertexAssembly;" << "\n\n";

         out_SHADER_INIT << "    spikes_00_SHADER_Fragment = glCreateShaderObjectARB( GL_FRAGMENT_SHADER_ARB );" << "\n\n";

         out_SHADER_INIT << "    unsigned char *spikes_00_SHADER_FragmentAssembly = readShaderFile( \"_MODEL_FOLDERS_/spikes_00/spikes_00.frag\" );" << "\n";
         out_SHADER_INIT << "    spikes_00_SHADER_FragmentStrings[0] = (char*)spikes_00_SHADER_FragmentAssembly;" << "\n";
         out_SHADER_INIT << "    glShaderSourceARB( spikes_00_SHADER_Fragment, 1, spikes_00_SHADER_FragmentStrings, NULL );" << "\n";
         out_SHADER_INIT << "    glCompileShaderARB(spikes_00_SHADER_Fragment );" << "\n\n";
    
         out_SHADER_INIT << "    delete spikes_00_SHADER_FragmentAssembly;" << "\n\n";

         out_SHADER_INIT << "	 spikes_00_SHADER = glCreateProgramObjectARB();" << "\n\n";
         out_SHADER_INIT << "    glAttachObjectARB( spikes_00_SHADER, spikes_00_SHADER_Vertex );" << "\n";
         out_SHADER_INIT << "    glAttachObjectARB( spikes_00_SHADER, spikes_00_SHADER_Fragment );" << "\n\n";

         out_SHADER_INIT << "    glLinkProgramARB(spikes_00_SHADER); " << "\n\n";  

         out_SHADER_INIT << "    UNIFORM_shininess_spikes_00 = glGetUniformLocationARB(  spikes_00_SHADER, \"shiny\" );   " << "\n\n";          
         
         out_SHADER_INIT << "    UNIFORM_counter1_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, \"counter1\" );" << "\n\n";
         out_SHADER_INIT << "    UNIFORM_counter2_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, \"counter2\" );" << "\n\n";
         out_SHADER_INIT << "    UNIFORM_counter3_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, \"counter3\" );" << "\n\n";
         out_SHADER_INIT << "    UNIFORM_counter4_spikes_00 = glGetUniformLocationARB( spikes_00_SHADER, \"counter4\" );" << "\n\n";
...
////////////////////////////////////////////////////_______VERTEX_SHADER______//////////////////////////////////////////////////////
ofstream out_vertexShader("spikes_00/spikes_00.vert");
...
////////////////////////////////////////////////////_____FRAGMENT_SHADER_____//////////////////////////////////////////////////////
ofstream out_fragmentShader("spikes_00/spikes_00.frag");
...
//////////////////////////////////////////////////////_______RENDER_______///////////////////////////////////////////////////////////
ofstream out_vboRender("spikes_00/spikes_00_vboRender.cpp");
         out_vboRender << "//glPushMatrix();"                                                                                                                 << "\n";    
         out_vboRender << "              glTranslatef(moveSet[0], moveSet[1], moveSet[2]);                                                "                   << "\n";           
         out_vboRender << "              glTranslatef(spikes_00_POSITION[0], spikes_00_POSITION[1], spikes_00_POSITION[2]);"                                              << "\n";       
         out_vboRender << "              glRotatef(rotation_AXIS_spikes_00[3]++,rotation_AXIS_spikes_00[0], rotation_AXIS_spikes_00[1], rotation_AXIS_spikes_00[2]);"         << "\n\n";          
         ...
         out_vboRender << "                   glLightfv(GL_LIGHT0,GL_POSITION,lightPos_spikes_00);"                                                      << "\n";
         out_vboRender << "                   glLightf (GL_LIGHT0, GL_QUADRATIC_ATTENUATION, lightAttenuation_spikes_00);"                               << "\n";
         out_vboRender << "              glPopMatrix();"                                                                                                      << "\n\n";           
         out_vboRender << "//glPopMatrix();"                                                                                                                  << "\n\n";           
         
        
         
         out_vboRender << "              glUseProgramObjectARB(spikes_00_SHADER);"                                                                       << "\n\n\n";     
         
         out_vboRender << "              glUniform1fARB( UNIFORM_shininess_spikes_00, shininess_spikes_00);"                                          << "\n";         
         
         out_vboRender << "              glUniform1fARB( UNIFORM_counter1_spikes_00, spikes_00_counter1);"                                          << "\n";
         out_vboRender << "              glUniform1fARB( UNIFORM_counter2_spikes_00, spikes_00_counter2);"                                          << "\n";
         out_vboRender << "              glUniform1fARB( UNIFORM_counter3_spikes_00, spikes_00_counter3);"                                          << "\n";         
         out_vboRender << "              glUniform1fARB( UNIFORM_counter4_spikes_00, spikes_00_counter4);"                                          << "\n\n\n";          
         
         out_vboRender << "              glBindBufferARB(GL_ARRAY_BUFFER_ARB, spikes_00_vboID);"                                                         << "\n\n";
         ...
         out_vboRender << "              glTexCoordPointer(3, GL_FLOAT, 0, (void*)(sizeof(spikes_00_VERT) + sizeof(spikes_00_NORM)));"              << "\n";              
         out_vboRender << "              glNormalPointer(GL_FLOAT, 0, (void*)sizeof(spikes_00_VERT));"                                                   << "\n";
         out_vboRender << "              glVertexPointer(3, GL_FLOAT, 0, 0);"                                                                                 << "\n\n";

         out_vboRender << "            //Texture3_textureID;"                                                                                                 << "\n";
         out_vboRender << "            //Texture3_textureID = glGetUniformLocationARB(spikes_00_SHADER,\"Texture3\");"                                   << "\n";
         ...
         out_vboRender << "              DOT3_textureID     = glGetUniformLocationARB(spikes_00_SHADER,\"NormalMap\");"                                  << "\n"; 
         ...
         out_vboRender << "              textureID     = glGetUniformLocationARB(spikes_00_SHADER,\"Texture1\");"                                        << "\n";
...
////////////////////////////////////////////////////________SHADOWS___________//////////////////////////////////////////////////////                                         
/*
ofstream out_shadows("spikes_00/spikes_00_vboShadow.cpp");         
         
         out_shadows << "   glScalef(scalespikes_00ShadowY[0],0,scalespikes_00ShadowY[2]); "                                      << "\n";
         out_shadows << "   glBindBufferARB(GL_ARRAY_BUFFER_ARB, spikes_00_vboID);"                                                    << "\n\n";
         ...
         out_shadows << "   glTexCoordPointer(3, GL_FLOAT, 0, (void*)(sizeof(spikes_00_VERT) + sizeof(spikes_00_NORM)));"         << "\n";
         out_shadows << "   glNormalPointer(GL_FLOAT, 0, (void*)sizeof(spikes_00_VERT));"                                              << "\n";
...
////////////////////////////////////////////////////_____LOCATION_STRINGS_____//////////////////////////////////////////////////////
ofstream out_LOCATION_STRINGS("spikes_00/_LOCATION_STRINGS.cpp");
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/spikes_00/spikes_00_vboGlobals.cpp\"  //vboID = " << "" << vboID <<"\n";                                              
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/spikes_00/spikes_00_vboRender.cpp\"   //vboID = " << "" << vboID <<"\n";
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/spikes_00/spikes_00_vboInit.cpp\"     //vboID = " << "" << vboID <<"\n";         
         out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/spikes_00/spikes_00_shaderInit.cpp\"  //vboID = " << "" << vboID <<"\n";         
         //out_LOCATION_STRINGS << "#include \"_MODEL_FOLDERS_/spikes_00/spikes_00_vboShadow.cpp\" //vboID = " << "" << vboID <<"\n";         
...
void display(void)
{
    ...
    ofstream outTexture( "spikes_00/spikes_00_TEX.cpp" );
    ofstream outNormal(  "spikes_00/spikes_00_NORM.cpp");
    ofstream outVertices("spikes_00/spikes_00_VERT.cpp");
    int j;
...
outTexture  << "GLfloat spikes_00_TEX[]   = \n" << "{\n"    << "  //number of vertices = " << object.polygons_qty*3 << "\n\n";
outNormal   << "GLfloat spikes_00_NORM[]  = \n" << "{\n"    << "  //number of vertices = " << object.polygons_qty*3 << "\n\n";	
outVertices << "GLfloat spikes_00_VERT[]  = \n" << "{\n"    << "  //number of vertices = " << object.polygons_qty*3 << "\n\n";
