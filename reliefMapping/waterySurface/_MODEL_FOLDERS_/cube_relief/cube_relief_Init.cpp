      ...
      "        vec3 dirEye           =  vec3(0.0,0.0, -1000.0);                                                  \n"  
     ...
     //-----------------------------------------------------------------------------------------------------------------
      ...
      " vec2 RayCast(sampler2D HMap, vec2 tc, vec3 ray, vec3 norm, float shiny);                                                             \n"  
      ...
      "         vec2 TexCoords = RayCast(HeightMap, varTexcoord.xy, EyeDir, normal, shininess);                           \n"      
      //------------------------------------------------------------------------------------------------------------------------
...
"      return tc-delta*height + norm.z * shiny;                                                                                                   \n"
