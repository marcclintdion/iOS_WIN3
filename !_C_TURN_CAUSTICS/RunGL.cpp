...
//---------------------------------------------------------------------------------------
var           eyeposition[]      =  {0, 3.4, 37.5, 0.0};
var           lookAt[]           =  {0, -2.8, 0, 0.0};
var           rotateModelWithLeftMouse[]           =  {1.60001, 0, };
...
//######################################################################################################################
                               ...
                               var           facing_UP_constantAttenuation                             =   0.8;
                               ...
                               //====================================================================================  
                               var           facing_VIEW_LIGHT_POSITION_01[]                           =  {2.5, -4.5009, 36.201, 0.0};
...
//==========================================================================================================================================================================
    ...
    //====================================================================================================================   
             ...
             {    
                 ...
                 //--------------------------------------------------------------------
                 lightSpheres_SCALE_ARRAY[i][0]        =  float((rand()% 10) - 5) *0.8; 
...
//====================================================================================                                          
        ...
        glBindTexture(GL_TEXTURE_2D, geometryLightPass_TEXTURE);   //blur is broken//replace with radial blur from->  F:\Documents\!!!_TRANSFER\!!!_iOS_WIN7\!1_AMBIENT_NEW - Copy      
        glActiveTexture (GL_TEXTURE0);                                                                                                                                            
        glBindTexture(GL_TEXTURE_2D, mainLightPass_TEXTURE);   
...
void ProcessKeyboard(void)
{
   ...
   //=======================================================================================  
    ...
    {	                                                                                                                                  
             facing_VIEW_LIGHT_POSITION_01[0]         +=  0.1;                                                                            
    }                                                                                                                                   
    ...
    {	                                                                                                                                  
             facing_VIEW_LIGHT_POSITION_01[1]         +=  0.1;                                                                            
    }	                                                                                                                                  
    ...
    {	                                                                                                                                  
             facing_VIEW_LIGHT_POSITION_01[2]         +=  0.1;                                                                          
    }	                                                                                                                                  
    ...
    if (keys['M'] && !keys[VK_SHIFT] && !keys[VK_CONTROL])                                                                                                                      
    {	                                                                                                                                  
             lightSpheres_constantAttenuation                   +=  0.1;                                                                            
    }	                                                                                                                                  
    if (keys['N'] && !keys[VK_SHIFT] && !keys[VK_CONTROL])                                                                                                                      
    {	                                                                                                                                  
            lightSpheres_constantAttenuation                   -=  0.1;                                                                            
